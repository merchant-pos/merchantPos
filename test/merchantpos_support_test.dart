...
void main() {
  ...
  group('siapa bicara dengan siapa', () {
    ...
    test('balasan admin menyebut nama penjawabnya', () {
      ...
      expect(layar, contains("'Merchant-POS Admin - \$n'"));
  ...
  group('urutan daftar', () {
    ...
    // biasanya mencari yang barusan dia kirim. Daftar Merchant-POS Admin
    ...
    test('daftar Merchant-POS Admin tetap yang terbaru di atas', () {
      final repo = File('lib/db/support_repository.dart').readAsStringSync();
  ...
  group('sapaan otomatis', () {
    ...
    test('disapa begitu tiketnya dibuka', () {
      ...
      expect(fn, contains('mohon bersabar Merchant-POS Admin akan meresponse'));
  ...
  group('chat bukan pengaduan', () {
    ...
    test('tidak pernah ditutup sendiri', () {
      ...
      expect(fn, contains("subject <> 'Chat dengan Merchant-POS Admin'"));
    });
  ...
  group('judul notifikasi', () {
    ...
    test('chat tidak pernah disebut pengaduan', () {
      ...
      expect(sql, contains("when v_chat then 'Balasan Merchant-POS Admin'"));
    });
  ...
  group('SQL-nya', () {
    ...
    group('penutupan otomatis', () {
      ...
      // Merchant-POS. Menutupnya karena "tidak ada jawaban" akan menghukum
  ...
  group('notifikasi', () {
    ...
    // orangnya masuk sebagai Merchant-POS Admin. Menyasar lewat peran gagal
    ...
    // Merchant-POS Admin tidak terikat merchant mana pun; menyertakan
  ...
  group('pintunya', () {
    ...
    test('Merchant-POS Admin punya menu Customer Service', () {
      final isi =
    ...
    test('tombolnya bulat kecil, bukan berlabel', () {
      ...
      expect(isi, contains("tooltip: 'Merchant-POS Support'"));
    });
    ...
    test('chat bebas memakai percakapan yang masih terbuka', () {
      ...
      final model =
          File('lib/models/support_ticket.dart').readAsStringSync();
      expect(model,
          contains("const kSubjekChatUmum = 'Chat dengan Merchant-POS Admin';"));
      final repo = File('lib/db/support_repository.dart').readAsStringSync();
